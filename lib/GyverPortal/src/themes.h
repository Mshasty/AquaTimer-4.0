...
"select{width:auto}\n"
".led{margin:9px 10px;}\n"
".led:after{width:20px;height:20px;border-radius:10px;top:-4px;left:-3px;position:relative;content:'';display:inline-block;background-color:#333;box-shadow:inset 0px 3px 0px 0px #fffff5}\n"
".led.red:checked:after{background-color:#d00;box-shadow:inset 0px 3px #fffff7,0px 0px 10px 1px #f00b;}\n"
".led.green:checked:after{background-color:#3c0;box-shadow:inset 0px 3px #fffff7,0px 0px 10px 1px #4d08;}\n"
".ledn{margin:9px 10px;}\n"
".ledn:after{width:20px;height:20px;border-radius:10px;top:-4px;left:-3px;position:relative;content:'';display:inline-block;background-color:#d00;box-shadow: inset 0px 3px #fffff7,0px 0px 10px 1px #f00b;}\n"
".ledn:checked:after{background-color:#3c0;box-shadow:inset 0px 3px #fffff7,0px 0px 10px 1px #4d08;}\n"
...
"input:checked+.slider{background-color:#5757E6}\n"
"input:checked+.slider:before{-webkit-transform:translateX(26px);-ms-transform:translateX(26px);transform:translateX(26px)}\n"
"output{display:inline-block;font-size:14px;padding:4px 3px;border-radius:4px;color:#fff;min-width:30px;background:#5757E6;margin-right:5px;}\n"
"input[type=range]{-webkit-appearance:none;width:70%;margin:12px 8px;height:12px;background:#fff;border:1px #b5b5b5 solid;border-radius:5px;background-repeat:no-repeat;cursor:pointer;padding:0px;background-image:linear-gradient(#BF8233,#FFAE44);}\n"
...
".display{display:inline-block;font-size:18px;padding:3px 5px;border-radius:4px;color:#fff;background:#5757E6;margin:2px 3px;}\n"
...
".navtab>ul{display:flex;flex-wrap:wrap;align-items:stretch;justify-content:center;list-style-type:none;margin:15px 0;padding:0;overflow:hidden;border-radius:5px;background:#82B91F;}\n"
...
"#blockBack input:checked+.slider{background-color:#2323CE}\n"
...
".blockTab{padding-top:0px;}\n"
".blockHeader{color:#000;font-size:22px;border-radius:10px 10px 0px 0px;background-color:#117AC4;padding:6px 0px;margin:0px -11px 10px -11px;}\n"
...
"textarea{max-width:300px}\n"
"input[type=submit],input[type=button],button{height:55px;font-size:24px;width:90%;max-width:300px;margin:8px 5px;background-color:#117AC4;background-image:linear-gradient(105deg,#5757E6,#3A3A9A);border:none;border-radius:8px;color:white;cursor:pointer;}\n"
"input[type=submit]:hover,input[type=button]:hover,button:hover{filter:brightness(0.95 );}\n"
"input[type=button],button{display:flex;align-items:center;justify-content:center;}\n"
"input[type=submit]:active,input[type=button]:active,button:active{box-shadow:inset 0px 1px 6px #0007;}\n"
...
".led.red:checked:after{background-color:#d00;box-shadow:inset 0px 3px 0px 0px #fffff7,0px 0px 10px 4px #f00b;}\n"
".led.green:checked:after{background-color:#3c0;box-shadow:inset 0px 3px 0px 0px #fffff7,0px 0px 10px 4px #4d08;}\n"
".ledn{margin:9px 10px;}\n"
".ledn:after{width:20px;height:20px;border-radius:10px;top:-4px;left:-3px;position:relative;content:'';display:inline-block;background-color:#d00;box-shadow:inset 0px 3px 0px 0px #fffff7,0px 0px 10px 2px #f00;}\n"
".ledn:checked:after{background-color: #3c0;box-shadow:inset 0px 3px 0px 0px #fffff7,0px 0px 10px 2px #4d0;}\n"
".miniButton{min-height:40px;height:auto!important;font-size:20px!important;width:auto!important;}\n"
".switch{margin:10px 0 5px;position:relative;display:inline-block;width:60px;height:34px}\n"
".switch input{opacity:0;width:0;height:0}\n"
".slider{border-radius:34px;position:absolute;cursor:pointer;top:-5px;left:0;right:0;bottom:5px;background-color:#545454;-webkit-transition:.4s;transition:.4s}\n"
".slider:before{border-radius:50%;position:absolute;content:'';height:26px;width:26px;left:4px;bottom:4px;background-color:#FFD044;-webkit-transition:.4s;transition:.4s}\n"
"input:checked+.slider{background-color:#2323CE}\n"
"input:checked+.slider:before{-webkit-transform:translateX(26px);-ms-transform:translateX(26px);transform:translateX(26px)}\n"
"output{display:inline-block;font-size:14px;padding:4px 3px;border-radius:4px;color:#fff;min-width:30px;background:#2323CE;margin-right:5px;}\n"
"input[type=range]{-webkit-appearance:none;width:70%;margin:12px 8px;height:12px;background:#2a2d35;border-radius:5px;background-repeat:no-repeat;cursor:pointer;padding:0px;background-image:linear-gradient(#BF9C33,#FFD044);}\n"
"input[type=range]::-webkit-slider-thumb{-webkit-appearance:none;height:15px;width:15px;}\n"
"input[type=range]:hover{filter:brightness(0.85);}\n"
".display{display:inline-block;font-size:18px;padding:3px 5px;border-radius:4px;color:#fff;background:#2323CE;margin:2px 3px;}\n"
"#ubtn{padding:0px 10px;height:40px;font-size:25px;margin:8px 5px;background-color:#117AC4;border:none;border-radius:8px;color:white;cursor:pointer;text-align:center;vertical-align:middle;}\n"
"#ubtnclr{height:0px;width:0px;overflow:hidden;}\n"
".navtab>ul{display:flex;flex-wrap:wrap;align-items:stretch;justify-content:center;list-style-type:none;margin:15px 0;padding:0;overflow:hidden;border-radius:5px;background:#2323CE;}\n"
".navtab>ul>li{display:flex;align-items:center;cursor:pointer;color:white;padding:8px 12px;}\n"
".navtab>ul>li:hover{background-color:#0001;}\n"
".navblock{display:none;padding:0;}\n"
"i{padding:5px 7px}\n"
...
".spinBtn{height:40px!important;width:40px!important;font-size:35px!important;}\n"
"#spinner input[type=number]{width:80px}\n"
"details>summary{font-size:18px;background-color:#117AC4;color:white;cursor:pointer;padding:10px 15px;border-radius:6px;user-select:none;      }\n"
"details[open]>summary{border-radius:6px 6px 0 0;}\n"
"details>summary>*{display:inline;}\n"
"details>div{border:2px solid #117AC4;padding:10px;border-radius:0 0 4px 4px;}\n"
"textarea::-webkit-scrollbar{width:6px;}\n"
"textarea::-webkit-scrollbar-track{background-color:#0000;}\n"
